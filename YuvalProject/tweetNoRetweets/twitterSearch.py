...
def load_api():
    ...
    consumer_key = "tFexy1Mtxa78UOZ1rKclf2L79"
    consumer_secret = "gUvkfKUrqGWjv3JJzlqLmfkivQme9OdPjoThxH5juayNrr5CTw"
    access_token = "374799441-uoi0jYFAz4lZlvnWIGXrpIuOdWpkhCdIsRUKbJX3"
    access_secret = "0uy4itf3HEu5AdVkJEw2JSzbp9yS1cds2EaVMKktsVycC"
...
def main():
    ...
    ''' search variables: '''
    search_phrases = ['superbowl -filter:retweets',
                     'kardashian -filter:retweets']
    ...
    USA = '39.8,-95.583068847656,10000km'       # this geocode includes nearly all American
